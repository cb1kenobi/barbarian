...
import { newReviewComments, parseReviewResult, runReviewAgent, type ReviewClaim } from './agents.js';
...
describe('runReviewAgent', () => {
  it('does not publish a GitHub review when no issues were found', async () => {
