...
const agentsSchema = z.object({
  ...
  autoAddressFeedback: z.boolean().default(false),
...
function safeUpdate(current: BarbarianConfig, submitted: WritableConfig): BarbarianConfig {
  return parseConfig({
    ...
    agents: {
      ...
      autoAddressFeedback: submitted.agents.autoAddressFeedback,
...
const writablePaths: Array<{ path: Array<string>; value: (config: BarbarianConfig) => unknown }> = [
  ...
  { path: ['agents', 'autoAddressFeedback'], value: (config) => config.agents.autoAddressFeedback },
