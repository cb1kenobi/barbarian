...
<header><div class="mark">B</div><div class="identity"><div class="brand">BARBARIAN</div><div class="branch-key">Branch review</div></div><button class="icon refresh" title="Refresh" aria-label="Refresh">↻</button></header>
