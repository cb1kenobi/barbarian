# Barbarian logo assets

The Barbarian mark is a vertically oriented, bilaterally symmetrical double-headed axe.

- `barbarian-axe.svg` is the themeable transparent mark. It uses `currentColor`; set the containing element's color to the active accent.
- `barbarian-axe.png` is the transparent Slayer-red raster mark.
